...
namespace Enemies
{
    ...
    public class ElderTurtle : Enemy
    {
        ...
        {
            audioManager.PlayOneShot(fmodEvents.elderTurtleDeathSound, transform.position);
        }

        protected override void PlayAttackSound()
        {
            audioManager.PlayOneShot(fmodEvents.elderTurtleAttackSound, transform.position);
        }
