...
namespace Enemies
{
    ...
    public class BeeHive : Enemy
    {
        ...
        protected override void Start()
        {
            ...
            if (!visualTransform.TryGetComponent(out visualAnimator))
            {
            ...
            audioManager.PlayOneShot(fmodEvents.beeHiveRaiseSound, transform.position);
        ...
        {
            audioManager.PlayOneShot(fmodEvents.beeHiveDeathSound, transform.position);
        }

        // Bee hive cannot attack
