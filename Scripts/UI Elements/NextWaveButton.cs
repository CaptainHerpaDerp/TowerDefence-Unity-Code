...
namespace UIElements
{
    ...
    public class NextWaveButton : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (canvasGroup == null)
            {
                Debug.Log("No canvas group assigned!");
            }
        ...
        #region Button Fading

        private void FadeInButton()
        {
            StartCoroutine(Utilities.Utils.FadeInCanvasGroup(canvasGroup, fadeTime));
        }

        private void FadeOutButton()
        {
            StartCoroutine(Utilities.Utils.FadeOutCanvasGroup(canvasGroup, fadeTime));
        }
